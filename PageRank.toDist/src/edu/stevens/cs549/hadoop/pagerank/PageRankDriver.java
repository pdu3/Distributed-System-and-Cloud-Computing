...
public class PageRankDriver {
	...
	public static void composite(String input, String output, String interim1,
		 ...
		 * TODO 
		 */
		System.out.println("Pei Du (10427182)");
	...
	static void deleteDirectory(String path) throws Exception {
		...
		static void translate(String names, String input, String output, int reducers) throws Exception {
			System.out.println("Translation Job Started");
			
			Job job = Job.getInstance(); // Creates a new Job
		    job.setJarByClass(PageRankDriver.class); // Sets the Driver class
		    job.setNumReduceTasks(reducers);
		    
		    FileInputFormat.addInputPath(job, new Path(names)); 
		    FileInputFormat.addInputPath(job, new Path(input));
		    FileOutputFormat.setOutputPath(job, new Path(output));
		    ...
		    System.out.println(job.waitForCompletion(true) ? "Translation Job Completed" : "Translation Job Error");
